...
checkEquals(bm$id, st$id)
checkEquals(bm$zone_id, st$zone_id)
checkEquals(bm$year, st$year)
checkEquals(bm$month, st$month)
checkEquals(bm$day, st$day)
...
dim(lh)
str(lh)
checkTrue(is.na(subset(lh, lh$zone_id == 11 & lh$year == 2008 & lh$month == 7 & lh$day == 5)$h1))
...
dim(w)
str(w)
checkEquals(160, subset(w, w$zone_id == 21 & w$year == 2008 & w$month == 7 & w$day == 5)$h1)
checkEquals(8, subset(w, w$zone_id == 6 & w$year == 2008 & w$month == 7 & w$day == 5)$h1)
checkEquals(20, subset(w, w$zone_id == 21 & w$year == 2005 & w$month == 12 & w$day == 26)$h1)
checkEquals(1, subset(w, w$zone_id == 6 & w$year == 2005 & w$month == 12 & w$day == 26)$h1)
